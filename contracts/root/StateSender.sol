...
contract StateSender is IStateSender {
     ...
     * Anyone can call this method to emit an event. Receiver on Metachain should add check based on sender.
     *
     * @param receiver Receiver address on Metachain
     * @param data Data to send on Metachain
     *
     */
