...
/**
    ...
    @dev Implements the base MetachainManager contract
 */
interface ICustomMetachainManager {
    ...
    /// @notice addGenesisBalance is used to specify genesis balance information for genesis accounts on the Metachains.
    /// It is applicable only in case Metachains native contract is mapped to a pre-existing rootchain ERC20 token.
