...
interface IRootERC20Predicate is IL2StateReceiver {
    ...
    /**
     * @notice Function that retrieves rootchain token that represents Metachains native token
     * @return address Address of rootchain token (mapped to Metachains native token)
     */
