...
const config: HardhatUserConfig = {
  ...
  etherscan: {
    apiKey: {
      ...
      Metachain: process.env.MetachainSCAN_API_KEY !== undefined ? process.env.MetachainSCAN_API_KEY : "",
      MetachainDubai: process.env.MetachainSCAN_API_KEY !== undefined ? process.env.MetachainSCAN_API_KEY : "",
    },
  },
  mocha: {
    timeout: 100000000,
